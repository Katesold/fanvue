...
7. add some more examples that can be actioned such as flagged in the seed data. move out the icons to separate folders and components.
...
modular scss has been chosen for it's robust features and modularity and scoped styles as well as fast speed, built in with the react ecosystem

Generic reusable components created like Table - DRY for

Performance considerd - memoisation and useDeferredValue for example

Functional programming with pure functions pronciples followed - testing in isolation possible

REST APIs and JSON error handling wrapper
